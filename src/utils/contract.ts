...
const provider = new ethers.JsonRpcProvider('https://mainnet.infura.io/v3/0c7b379c34424040826f02574f89b57d');
...
export const vPLSContract = new ethers.Contract(vPLSAddress, vPLSAbi, provider);
